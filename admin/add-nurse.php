...
if (isset($_SESSION["admin_id"])) {
    ...
    // If the admin adds a new Nurse (i.e clicks on "add Nurse" button)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary w-100">Add Nurse</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <footer class="navigation_section">
        <div class="container">
            <div class="d-flex justify-content-between px-0 px-sm-5">
                ...
                <a href="./add-nurse.php" class="d-flex flex-column justify-content-center align-items-center active">
                    <i class="fa fa-user-plus" aria-hidden="true"></i>
                    Add Nurse
                </a>
